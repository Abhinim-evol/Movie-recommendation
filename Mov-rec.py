...
os.chdir('D:\\DS Sep 25 Day 21 Projects\\PRJ Movie Recommendation\\')
display (os.getcwd())
...
# This line replaces all missing values (NaN) in that column with an empty string ('').
...
# Converting the text data to feature vectors/Bag of Words
